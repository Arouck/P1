...
def core(remote, host, port):
    ...
    joao = Person("jvcanavarro@gmail.com", "Joao", "Canavarro", "Belem",
                  "UFPA", ["Python", "NLP", "Speech Recognition"],
    ...
    isabela = Person("isa.maues@gmail.com", "Isabela", "Maues", "Belem",
                     "UFPA", ["C++", "Design", "Figma"],
                     ['Student at Logos', 'Temp at LAAI', 'Fellow at Vale'])

    sys.excepthook = Pyro4.util.excepthook
    system = Pyro4.Proxy(f"PYRO:system.core@{host}:{port}"
                         ) if remote else Pyro4.Proxy("PYRONAME:system.core")
    ...
    system.add_xp_to_user(email="ppvitor@gmail.com",
                          experience="Developer at w")
